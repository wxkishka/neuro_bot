# Модуль хранения настроек пользователя.
...
def create_new_token():
    """Функция возращает новый IAM_TOKEN."""
...
def get_creds():
    """Функция возращает iam_token и folder_id из файлов."""
    try:
        # чтение iam_token
...
def get_bot_token():
    """Функция возвращает token для бота."""
